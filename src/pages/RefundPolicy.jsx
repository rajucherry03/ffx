...
function RefundPolicy() {
  return (
    <div className="max-w-4xl mx-auto p-6 text-gray-800">
      ...
      <h3 className="text-lg font-semibold mt-4">Software Development and Project Development</h3>
      <p>Clients may cancel an ongoing project by submitting a written notice to <a href="mailto:futureforgex.pvt@gmail.com" className="underline">futureforgex.pvt@gmail.com</a>.</p>
      ...
      <p>Participants may cancel enrollment by submitting a written notice to <a href="mailto:futureforgex.pvt@gmail.com" className="underline">futureforgex.pvt@gmail.com</a>.</p>
      <ul className="list-disc ml-6 mb-4">
      ...
      <p>Since we provide digital services, we do not accept returns. However, we offer solutions for unsatisfactory services.</p>
      ...
      <p>Upon full payment, clients receive a non-exclusive license for project deliverables. FutureForgeX retains the right to showcase completed work unless otherwise agreed.</p>
      
      <h2 className="text-xl font-semibold mt-6 mb-3">DISPUTE RESOLUTION</h2>
      <p>Disputes will first be addressed through negotiation. Legal matters will be governed by the laws of Andhra Pradesh, India.</p>
      
      <h2 className="text-xl font-semibold mt-6 mb-3">PRIVACY AND DATA PROTECTION</h2>
      <p>Our Privacy Policy governs data usage. By using our services, you consent to our data practices. See our <a href="/privacy-policy" className="underline text-blue-600">Privacy Policy</a> for details.</p>
      ...
      <p>Email: <a href="mailto:futureforgex.pvt@gmail.com" className="underline">futureforgex.pvt@gmail.com</a></p>
      <p>Phone: <a href="tel:+918499956365" className="underline">+91 8499956365</a></p>
      <p>Website: <a href="https://www.futureforgex.in" className="underline" target="_blank" rel="noopener noreferrer">www.futureforgex.in</a></p>
      <p>Address: Madanapalle, Andhra Pradesh, India</p>
      
      <h2 className="text-xl font-semibold mt-6 mb-3">ENTIRE AGREEMENT</h2>
      <p>This policy constitutes the entire agreement regarding cancellations, returns, and refunds.</p>
      ...
      <p>We reserve the right to terminate or suspend access for policy violations.</p>
    </div>
  );
}
