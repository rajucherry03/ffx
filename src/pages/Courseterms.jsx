...
const CourseTerms = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 text-gray-800">
      <h1 className="text-3xl font-semibold mb-6 text-center">FUTUREFORGEX EDUCATION & TRAINING COURSE TERMS</h1>
      ...
      <p className="mb-4">FutureForgeX reserves the right to refuse or cancel enrollment if eligibility criteria are not met.</p>
      ...
      <p className="mb-4">Violations may result in course removal without a refund.</p>
      
      <h2 className="text-xl font-semibold mt-6 mb-3">CONFIDENTIALITY</h2>
      <p className="mb-4">Participants may have access to confidential information and must not disclose it without prior written consent.</p>
      
      <h2 className="text-xl font-semibold mt-6 mb-3">CERTIFICATION</h2>
      <p className="mb-4">Participants who meet all requirements will receive a certificate of completion. This certificate does not confer academic credit or professional licensure.</p>
      
      <h2 className="text-xl font-semibold mt-6 mb-3">LIMITATION OF LIABILITY</h2>
      <p className="mb-4">FutureForgeX is not liable for any indirect or consequential damages arising from course participation. Our total liability shall not exceed the course fee paid.</p>
      
      <h2 className="text-xl font-semibold mt-6 mb-3">GOVERNING LAW</h2>
      <p className="mb-4">These Terms are governed by the laws of Andhra Pradesh, India. Disputes shall be resolved in the courts of Andhra Pradesh.</p>
      
      <h2 className="text-xl font-semibold mt-6 mb-3">CHANGES TO THESE TERMS</h2>
      <p className="mb-4">FutureForgeX reserves the right to modify these Terms at any time, with changes effective upon posting on the website.</p>
      
      <h2 className="text-xl font-semibold mt-6 mb-3">CONTACT US</h2>
      <p className="mb-2">For inquiries regarding these Terms or the Course, contact us at:</p>
      <p className="mb-4">Email: <a href="mailto:courses@futureforgex.com" className="underline">courses@futureforgex.com</a></p>
